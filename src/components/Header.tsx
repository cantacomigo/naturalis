...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-xl border-b border-stone-200/70 shadow-xs transition-all">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1.5 sm:py-2 flex items-center justify-between gap-3 sm:gap-6">
        {/* Brand Logo & Name */}
        <div className="flex items-center gap-3 sm:gap-4">
          <div className="relative group cursor-pointer shrink-0 transition-transform hover:scale-105 flex items-center">
            <NaturalisLogo className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 drop-shadow-md" priority />
            <div
              className={`absolute bottom-0.5 right-0.5 w-4 h-4 sm:w-4.5 sm:h-4.5 ${
