    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-950/50 backdrop-blur-xs animate-in fade-in duration-200">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto flex-1 p-5 space-y-4">
          ...
          {/* Fruit Pulp Orders & Supplier Settings */}
          <div className="p-4 bg-emerald-50/60 rounded-2xl border border-emerald-200 space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-xs font-bold text-emerald-950">
                <span className="text-sm">🥭</span>
                <span>Fornecedor & Pedidos de Polpas de Frutas</span>
              </div>
              {onOpenFruitPulp && (
                <button
                  type="button"
                  ...
                  className="px-2.5 py-1 bg-white hover:bg-emerald-100 text-emerald-900 border border-emerald-300 rounded-lg text-[11px] font-bold flex items-center gap-1 transition-colors cursor-pointer"
                >
                  <ExternalLink className="w-3 h-3 text-emerald-700" />
                  <span>Abrir Módulo de Polpas</span>
                </button>
              )}
            </div>
            ...
            <div>
              <label className="text-[11px] font-semibold text-stone-700 block mb-1">
                Link do Projeto de Polpas (Google AI Studio / Applet)
              </label>
              <input
                type="url"
                value={formData.fruitPulpAppUrl || 'https://aistudio.google.com/apps/ed1b11a4-eeb9-45b2-a82b-149eb44c4413?showAssistant=true&showPreview=true'}
                onChange={(e) => setFormData({ ...formData, fruitPulpAppUrl: e.target.value })}
                placeholder="https://aistudio.google.com/apps/..."
                className="w-full bg-white border border-emerald-300 rounded-xl px-3 py-2 text-xs text-stone-900 font-mono focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="text-[11px] font-semibold text-stone-700 block mb-1">
                  Nome do Fornecedor de Polpas
                </label>
                <input
                  type="text"
                  value={formData.fruitPulpSupplierName || ''}
                  onChange={(e) => setFormData({ ...formData, fruitPulpSupplierName: e.target.value })}
                  placeholder="Ex: Distribuidora de Polpas Naturais"
                  className="w-full bg-white border border-emerald-300 rounded-xl px-3 py-2 text-xs text-stone-900 font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.fruitPulpSupplierPhone || ''}
                  onChange={(e) => setFormData({ ...formData, fruitPulpSupplierPhone: e.target.value })}
