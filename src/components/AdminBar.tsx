    ...
    <div className="bg-stone-900 text-stone-100 border-b border-stone-800 shadow-md sticky top-0 z-50 animate-in slide-in-from-top-2 duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex flex-wrap items-center justify-between gap-2 text-xs">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {/* Quick Vitrine / Hero Banner Toggle */}
          {onToggleHeroBanner && (
            <button
              type="button"
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
          ...
          {/* Fruit Pulp Orders Button */}
          <button
            type="button"
            onClick={onOpenFruitPulp}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-800/90 hover:bg-emerald-700 text-emerald-100 hover:text-white font-bold transition-all cursor-pointer border border-emerald-600/60 active:scale-95 text-xs shadow-2xs"
            id="admin-bar-fruit-pulp-btn"
            title="Módulo de Suprimentos: Abrir Sistema de Pedidos de Polpas de Frutas"
          >
            <span className="text-xs">🥭</span>
            <span className="hidden sm:inline">Pedidos de Polpas</span>
            <span className="sm:hidden">Polpas</span>
          </button>
          ...
          <button
            type="button"
            onClick={() => orderSoundManager.playIFoodOrderAlert()}
            className="flex items-center gap-1 px-2 py-1.5 rounded-lg bg-stone-800 hover:bg-stone-700 text-stone-300 hover:text-white font-medium transition-all cursor-pointer border border-stone-700 text-xs"
            title="Testar toque de novo pedido (Estilo iFood / Telefone)"
            id="admin-bar-test-sound-btn"
          >
            <Volume2 className="w-3.5 h-3.5 text-amber-400" />
            <span className="hidden xl:inline">Som iFood</span>
          </button>
